...
links.to_a.each do |link|
      begin
          if link.include?("facebook")
              ...
              begin
                catkey="LOGGEDINFORMATIONSEARCHSCHEMA"
                ...
                browser.wait_until do |b|
                    b.text.include?("Recherche")
                end
                a=1
                mystr="Vous avez recherché"
                mystr1="Vous avez visité"
                while browser.text.include?(mystr1) or  browser.text.include?(mystr) do
                    while browser.text.include?(mystr1) or browser.text.include?(mystr) do
                ...
                browser.execute_script("alert('finish les personnes sont supprimees')")
